...
export type GetProductResponse = ProductSearchResponse | GetProduct | GetProductsResponse  // QueryResponse<'products', ProductSearchResponse | GetProduct | GetProductsResponse>; 
